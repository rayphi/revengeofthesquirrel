...
public class HUDLayer extends LayerImpl {
	...
	public HUDLayer() {
		...
		// Die höchste Priorität wird als letztes gezeichnet und liegt somit ganz oben,
	...
	private void InitScoreHUD(){
		...
		// TODO der Score muss dynamisch via spring ermittelt und über ein TextualGameObject updateable gemacht werden
		// Den Score anzeigen
